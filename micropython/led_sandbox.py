...
# Real-hardware feedback (2026-08-16): 0.5-1.0 (2x) wasn't differentiable
# bare; widened to 0.4-1.6 (4x), which worked bare but only "subtly"
# in-bottle (frosted glass compresses brightness contrast — the real
# target, not the bare strip). Widened again — see gesture_sandbox.py's
# matching constants for the full round-by-round history.
ACK_PEAK_FLOOR = 0.35
ACK_PEAK_CEIL = 2.2
SHELF_FLOOR = 0.08
SHELF_CEIL = 0.25
