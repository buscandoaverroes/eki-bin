...
| Tilt-to-adjust: the go-up-first overshoot (**run it in the dark**), and `curve_test` — timed target acquisition for tuning the expo `CURVE` | `micropython/tilt_sandbox.py` (`make tilt-sandbox`) |
